...
fusen::fill_description(overwrite = T,
  pkg = here::here(),
  fields = list(
    Title = "Build mytools Rpackage",
    Description = "A package that contains functions for statistical analysis.",
    `Authors@R` = c(
      person("Moses", "Mburu", email = "moses.mburu@finddx.org", role = c("aut", "cre"))
    )
  )
)
